...
const Saved = () => {
  const { savedData, storeError, resetSavedResult } = useContext(StorageContext);
          ...
          <table className='w-full table-auto'>
            ...
            <tbody>
              {savedData &&
                savedData.map(data => {
                  return (
                    <tr key={data.id} className='text-base text-center border-b border-gray-100 hover:bg-gray-200'>
