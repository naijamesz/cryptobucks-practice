      ...
      {data ? (
        <>
          <h3 className='text-base flex items-center my-0.5'>
            ...
            <img src={data.small} alt={data.id} className='w-[1.5rem] h-[1.5rem] mx-1.5 rounded-full' />
          </h3>
          <h3 className='text-base flex items-center my-0.5'>
          ...
          <img
            src={data.large}
            alt={data.id}
            className='absolute lg:top-2/4 top-4 lg:-right-10 -right-6 -translate-y-2/4  lg:w-[29%] w-[5rem]   h-auto rounded-full'
          />
        </>
      ) : null}
    </div>
