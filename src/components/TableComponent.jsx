...
const SaveBtn = ({ data }) => {
  ...
  return (
    <button className='border-0 cursor-pointer outline-0 bg-none' onClick={e => handleClick(e, data.id)}>
      <svg
...
const TableComponent = () => {
  ...
  return (
    <>
      <div className='flex flex-col border border-gray-100 rounded mt-9 '>
        {cryptoData ? (
                  ...
                  return (
                    <tr
                      ...
                      <td className='flex items-center py-4 uppercase'>
                        <SaveBtn data={data} />
                        <img src={data.image} alt={data.id} className='w-[1.2rem] h-[1.2rem] mx-1.5' />
                      ...
                      <td className='hidden py-4 sm:table-cell'>{data.total_volume}</td>
                      <td
                        className={
          ...
          <h1 className='min-h-[60vh] text-lg text-red flex items-center justify-center '>
            {error.data ? error.data : error.search ? error.search : 'Something unexpected happened!'}
          </h1>
        ) : null}
      </div>
      <div className='flex md:flex-row flex-col items-center justify-between  mt-4 capitalize h-[2rem] '>
        <span>
          Data provided by{' '}
          <a className='text-cyan' href='https://www.coingecko.com' target={'_blank'} rel='noreferrer'>
            CoinGecko
          </a>
        </span>
